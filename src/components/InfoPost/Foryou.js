                ...
                {fake.map((item, index) => (
                    <div className={cx("box-foryou", "swiper-slide")} key={index}>
                        <div className={cx("box-thumb")}>
                            <img src="https://images.unsplash.com/photo-1643029891412-92f9a81a8c16?q=80&w=2086&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="thumb" />
                        </div>
                        <div className={cx("box-content")}>
                            <div className={cx("box-title-foryou")}>
                                Quỹ căn studio và 1 ngủ + có CK 3% - view pháo hoa, sông Hàn - Sun Symphony Đà Nẵng. Giá từ 2.8 tỷ
                            </div>
