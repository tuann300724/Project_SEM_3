/* eslint-disable jsx-a11y/iframe-has-title */
    ...
    function InfoPost(props) {
        ...
        useEffect(() =>{
            axios.get(`http://localhost:5117/api/Post/title/${param.slug}`)
            .then(res => {
                ...
                axios.get(`http://localhost:5223/api/user/${data.userId}`)
                .then(res => {
                    console.log(res.data.data)
                                ...
                                <div className={cx("content-info-price")}>
                                    <div className='d-flex'>
                                        <div className={cx("info-price")}>
                                            ...
                                            <span className={cx("price")}>{formatPrice(data.price)}</span>
                            ...
                            <div className={cx("container-content-right")}>
                                <div className={cx("sidebar-box-contact")}>
                                    ...
                                    <div className={cx("button-contact")}>
                                        <span> <FontAwesomeIcon icon={faPhone} /> {user.phone}</span>
                                    </div>
                                    ...
                                    <Link to="#" onClick={() => window.open(mailtoLink, '_blank')}target="_blank" style={{color: "#000"}}>
