  ...
  const handleLoginSuccess = async (response) => {
    try {
      ...
      const checkEmailGoogle = await fetch(
        "http://localhost:5223/api/Auth/check-email-exists",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className={cx("layout-leftX2")}>
        <div className={cx("wrapper-layout-left")}>
          <div>
            ...
            <div className={cx("footerlogin")}>
              ...
              >
                <div
                  className={cx("forget-passwordx2")}
                  type="primary"
            ...
            <div className={cx("footer-login")} type="tertiary">
              ...
              >
                <div
                  className="sc-bqyKva kNPgPf sc-jifIRw fiHoWs"
                  type="primary"
                >
                  Policies
                </div>
        ...
        <div className={cx("wrapper-register")}>
          <div type="primary" className={cx("register")}>
            Not registered yet?{" "}
            <a type="primary" href="/register" className={cx("footer-b")}>
