...
function UserPost(props) {
  ...
  return (
    <div className={cx("container-post", "container-xl")}>
      ...
      <div className={cx("type-city-input")}>
        <input type="text" placeholder="Chọn" value={fullcity.name} />
      </div>
      <div className={cx("type-house-title")}>Vị trí hiển thị trên bản đồ </div>
      ...
      <div className={cx("input-price-percent-group")}>
        <input type="number" className={cx("input-price")} pattern="[0-9]" />
      ...
      <div className={cx("type-house-title")}>Nội thất</div>

      <div className={cx("select-legal")}>
        <select>
          <option value="">Đầy đủ</option>
          <option value="">Cơ bản</option>
          <option value="">Không nội thất</option>
        </select>
      </div>
      ...
      <section>
        <div tabindex="0">
          <div className={cx("gJwRHP")} onClick={handleImage}>
            ...
            <div type="primary" class="sc-crrsfI fAPcKa">
              Bấm để chọn ảnh cần tải lên
            </div>
            <div
              type="tertiary"
              class="sc-crrsfI fmnTOX"
      ...
      <div className={cx("show-image")}>
        <div className={cx("row")}>
          {images ? (
            <div className={cx("col-xl-3 col-lg-4 col-md-6 col-12")}>
